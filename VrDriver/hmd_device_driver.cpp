...
static const char* my_hmd_main_settings_section = "driver_optiforge";
static const char* my_hmd_display_settings_section = "optiforge_display";
...
MyHMDControllerDeviceDriver::MyHMDControllerDeviceDriver()
{
	...
	vr::VRSettings()->SetString(my_hmd_main_settings_section, "serial_number", "optiforge");
	vr::VRSettings()->SetString(my_hmd_main_settings_section, "model_number", "optiforge");
...
vr::EVRInitError MyHMDControllerDeviceDriver::Activate(uint32_t unObjectId)
{
	...
	// of our driver.
	vr::VRProperties()->SetStringProperty(container, vr::Prop_InputProfilePath_String, "{optiforge}/input/optiforge_profile.json");
